...
public class UtilGravity {
	...
	public static void taskUpdateVelocity(Player paramPlayer) {	
	        Vector paramVectorToUpdate1 = paramPlayer.getVelocity().clone();
	        UUID localUUID = paramPlayer.getUniqueId();
	        if ((velocities.containsKey(localUUID)) && (onGround.containsKey(localUUID)) && (!paramPlayer.isOnGround()) && (!paramPlayer.isInsideVehicle()))
	        {
	          ...
	          if (!((Boolean)onGround.get(localUUID)).booleanValue())
	          {
	            ...
	            if ((d1 > 0.0D) && ((paramVectorToUpdate1.getY() < -0.01D) || (paramVectorToUpdate1.getY() > 0.01D)))
	            {
	              ...
	              int k = (paramVectorToUpdate1.getX() >= -0.001D) && (paramVectorToUpdate1.getX() <= 0.001D) ? 0 : 1;
	              int m = (paramVectorToUpdate2.getX() >= -0.001D) && (paramVectorToUpdate2.getX() <= 0.001D) ? 0 : 1;
	              if ((k != 0) && (m != 0)) {
	                paramVectorToUpdate1.setX(paramVectorToUpdate2.getX());
	              }
	              int n = (paramVectorToUpdate1.getZ() >= -0.001D) && (paramVectorToUpdate1.getZ() <= 0.001D) ? 0 : 1;
	              int i1 = (paramVectorToUpdate2.getZ() >= -0.001D) && (paramVectorToUpdate2.getZ() <= 0.001D) ? 0 : 1;
	              if ((n != 0) && (i1 != 0)) {
	          ...
	          else if (((paramPlayer instanceof Player)) && 
	            (positions.containsKey(localUUID)))
	          {
